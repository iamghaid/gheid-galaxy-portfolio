...
export const IMAGE_SCENE = {
    ...
    IMAGES_DATA: {
        continent: { width: 1363, height: 667, targetRepeat: { x: 0.1, y: 0.1 }, targetCoords: { x: 450, y: 375 } },
        city: { width: 985, height: 547, targetRepeat: { x: 0.1, y: 0.1 }, targetCoords: { x: 260, y: 372 } },
